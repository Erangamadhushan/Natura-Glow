    ...
    return (
        <div>
            <nav className='w-full max-w-[100%] flex justify-between items-center bg-black p-4'>
                <div>
                    <h1 className='text-2xl text-white font-bold'>Natura Glow</h1>
                </div>
                <div className='hidden md:flex md:flex-start space-x-4'>
                    ...
                    <Link to="/service" className='text-white hover:text-gray-300 text-lg'>Service</Link>
                </div>
                ...
                <div className='md:hidden flex items-center space-x-4'>
                    <button className='bg-black text-white px-4 py-2 rounded-md duration-1000 hover:bg-pink-600' onClick={handleNavbar}><img src={menu} style={iconsStyle} alt='menu'/></button>
                </div>
