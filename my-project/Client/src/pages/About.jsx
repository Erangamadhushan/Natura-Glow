    ...
    return (
      <>
        <div className="about-container max-w-[1000px] mx-auto flex flex-col py-10 scroll-up p-3">
            <h2 className=" text-[2.5em] md:text-[4.5em] text-center md:text-justify text-pink-500 font-semibold">Welcome to Natura Glow ,</h2>
        ...
        <div className="about-container max-w-[1000px] mx-auto flex flex-col py-10 scroll-up p-3">
            <h2 className="text-[2.5em]  font-bold">Natura Glow <span className="text-pink-500">Brand Story</span></h2>
        ...
        <div className="about-container max-w-[1000px] grid grid-cols-1 md:grid-cols-2 mx-auto  py-10">
            <div className="p-5 border-l-2 border-r-2 border-pink-500 scroll-up">
              <h2 className="text-[2.5em]  font-bold">Our <span className="text-pink-500">Mission</span></h2>
            ...
            <div className="p-5 border-l-2 border-r-2 border-pink-500 scroll-up">
              <h2 className="text-[2.5em]  font-bold">Our <span className="text-pink-500">Vision</span></h2>
